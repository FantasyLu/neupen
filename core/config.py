...
▶ 克制比喻，禁止堆叠形容词
  比喻只在能让读者产生新感知时使用，否则直接写动作/感觉本身。
  ❌ 冗余比喻：「他的心像被一只无形的手攥住，又像溺水者抓住最后一根稻草。」
  ✅ 去掉比喻，写身体反应：「他吸了口气，没吸进去。」
  ❌ 堆叠形容词：「漆黑阴冷潮湿的走廊」「沉重而压抑的沉默」
  ✅ 保留最精准的一个，其余用动作替代：「走廊里的冷气顺着领口往下钻。」
  判断标准：去掉这个比喻/形容词，句子的信息量有没有损失？没有损失 → 删。
